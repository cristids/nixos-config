...
in {
  ...
  services.fprintd = {
    ...
    #   driver = libfprintTod;
    # };
    # Optional: Enable fprintd for other drivers if needed
    # enable = true;
    # drivers = [ "libfprint-focaltech-2808-a658" ];
  };
  ...
  # environment.systemPackages = [ pkgs.fprintd libfprintTod ];

  # Ensure udev rules are active
  services.udev.packages = [ pkgs.gusb libfprintTod ];
